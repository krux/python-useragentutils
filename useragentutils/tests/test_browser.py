...
from useragentutils.browser import Browser
from useragentutils.version import Version


ie6clients = [
    'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; T312461)',
    'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.1.4322; XMPP Tiscali Communicator v.10.0.2; '
    '.NET CLR 2.0.50727)',
...
ie8clients = [
    'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; WOW64; SLCC1; .NET CLR 2.0.50727; .NET CLR 3.0.04506; Media '
    'Center PC 5.0; .NET CLR 1.1.4322)',
    'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; Win64; x64; .NET CLR 2.0.50727; SLCC1; Media Center PC 5.0; '
    '.NET CLR 3.0.04506)'
]
...
outlook2007 = [
    'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; SLCC1; .NET CLR 2.0.50727; .NET CLR 3.0.04506; .NET CLR '
    '1.1.4322; MSOffice 12)'
]

outlook2010 = [
    'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; Trident/4.0; GTB6.4; Mozilla/4.0 (compatible; MSIE 6.0; '
    'Windows NT 5.1; SV1) ; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 1.1.4322; .NET CLR 3.5.30729; '
    '.NET CLR 3.0.30729; OfficeLiveConnector.1.3; OfficeLivePatch.0.0; MSOffice 14)',
    'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/4.0; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR '
    '3.5.30729; Media Center PC 6.0; SLCC2; ms-office; MSOffice 14)'
]

outookExpress = [
    'Outlook-Express/7.0 (MSIE 6.0; Windows NT 5.1; SV1; SIMBAR={xxx] .NET CLR 2.0.50727; .NET CLR 1.1.4322; '
    'TmstmpExt)',
...
ieMobile6 = [
    ...
    'Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 6.8) PPC; 240x320; HTC_TyTN/1.0 Profile/MIDP-2.0 '
    'Configuration/CLDC-1.1'
]

ieMobile7 = [
    'HTC_TouchDual Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 7.6)',
    'PPC; 240x320; HTC_P3450/1.0 Profile/MIDP-2.0 Configuration/CLDC-1.1 Mozilla/4.0 (compatible; MSIE 6.0; Windows '
    'CE; IEMobile 7.6)',
    'Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 7.6) PPC; MDA Vario/3.0 Profile/MIDP-2.0 '
    'Configuration/CLDC-1.1',
...
chromeMobile = [
    ...
    'Mozilla/5.0 (Linux; U; Android-4.0.3; en-us; Galaxy Nexus Build/IML74K) AppleWebKit/535.7 (KHTML, like Gecko) '
...
safari = [
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_7; en-us) AppleWebKit/525.28.3 (KHTML, like Gecko) Version/3.2.3 '
    'Safari/525.28.3',
...
safari5 = [
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_4; en-us) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 '
    'Safari/533.16',
    'Mozilla/5.0 (Windows; U; Windows NT 6.1; ja-JP) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/533.16',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_5; en-us) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 '
    'Safari/533.19.4',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_7; da-dk) AppleWebKit/533.21.1 (KHTML, like Gecko) Version/5.0.5 '
    'Safari/533.21.1'
]

safari4 = [
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_2; en-us) AppleWebKit/531.21.8 (KHTML, like Gecko) Version/4.0.4 '
    'Safari/531.21.10',
    'Mozilla/5.0 (Windows; U; Windows NT 6.1; es-ES) AppleWebKit/531.22.7 (KHTML, like Gecko) Version/4.0.5 '
    'Safari/531.22.7',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_7; en-us) AppleWebKit/531.2+ (KHTML, like Gecko) Version/4.0.1 '
    'Safari/530.18'
]
...
mobileSafari = [
    ...
    'Mozilla/5.0 (iPod; U; CPU iPhone OS 2_0 like Mac OS X; de-de) AppleWebKit/525.18.1 (KHTML, like Gecko) '
    'Version/3.1.1 Mobile/5A347 Safari/525.20',
    # Mobile Safari 3.1.1
    ...
    'Mozilla/5.0 (iPod; U; CPU iPhone OS 4_1 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML, like Gecko) '
...
omniWeb = [
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_8; en-US) AppleWebKit/531.9+(KHTML, like Gecko, Safari/528.16) '
    'OmniWeb/v622.10.0',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-US) AppleWebKit/525.18 (KHTML, like Gecko, Safari/525.20) '
    'OmniWeb/v622.3.0.105198'
]
...
camino2 = [
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en; rv:1.9.0.19) Gecko/2010111021 Camino/2.0.6 (MultiLang) (like '
    'Firefox/3.0.19)',
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en; rv:1.9.0.18) Gecko/2010021619 Camino/2.0.2 (like '
    'Firefox/3.0.18)'
]

camino = [
    'Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; it; rv:1.8.1.21) Gecko/20090327 Camino/1.6.7 (MultiLang) (like '
    'Firefox/2.0.0.21pre)',
...
class BrowserTest(unittest.TestCase):
    def testIsBrowser(self):
        self.assertTrue(Browser.SAFARI.isInUserAgentString(
    ...
    def test_version_detection(self):
        ...
        self.versionTest('Mozilla/6.0 (compatible; Konqueror/4.2; i686 FreeBSD 6.4; 20060308)',
                         Version('4.2', '4', '2'))
        self.versionTest('Mozilla/5.0 (compatible; Konqueror/3.1-rc5; i686 Linux; 20021219)',
                         Version('3.1-rc5', '3', '1'))
        self.versionTest(
            'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.14) Gecko/2009090216 Ubuntu/9.04 (jaunty) Firefox/3.0.14',
            Version('3.0.14', '3', '0'))
        self.versionTest(
            'Mozilla/4.0 (compatible; MSIE 7.0b; Windows NT 6.0 ; .NET CLR 2.0.50215; SL Commerce Client v1.0; Tablet '
            'PC 2.0',
            Version('7.0b', '7', '0b'))  # is minor here b or 0b?
        ...
        self.versionTest(
            'Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) AppleWebKit/534.10 (KHTML, like Gecko) Chrome/8.0.558.0 '
            'Safari/534.10',
            Version('8.0.558.0', '8', '0'))
        self.versionTest(
            'Mozilla/5.0 (X11; U; Linux x86_64; en-US) AppleWebKit/540.0 (KHTML,like Gecko) Chrome/9.1.0.0 '
            'Safari/540.0',
            Version('9.1.0.0', '9', '1'))
        self.versionTest(
            'Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-gb) AppleWebKit/523.10.6 (KHTML, like Gecko) Version/3.0.4 '
        ...
        self.versionTest(
            ...
            Version('4.0', '4', '0'))
        self.versionTest(
            'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; Trident/4.0; GTB6.4; Mozilla/4.0 (compatible; MSIE '
            '6.0; Windows NT 5.1; SV1) ; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 1.1.4322; .NET CLR '
            '3.5.30729; .NET CLR 3.0.30729; OfficeLiveConnector.1.3; OfficeLivePatch.0.0; MSOffice 14)',
            Version('14', '14', '0'))
        self.versionTest(
            'Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; it; rv:1.8.1.21) Gecko/20090327 Camino/1.6.7 (MultiLang) '
            '(like Firefox/2.0.0.21pre)',
            Version('1.6.7', '1', '6'))
        self.versionTest('Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.3) Gecko/2008100716 Firefox/3.0.3 Flock/2.0',
                         Version('2.0', '2', '0'))
        self.versionTest(
            'Mozilla/5.0 (Macintosh; U; Intel Mac OS X; en-US; rv:1.8.1.17) Gecko/20080914 Thunderbird/2.0.0.17',
            Version('2.0.0.17', '2', '0'))
        self.versionTest('Mozilla/4.0 (compatible; Lotus-Notes/5.0; Windows-NT)', Version('5.0', '5', '0'))
        self.versionTest(
            'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1.13) Gecko/20100914 Mnenhy/0.8.3 SeaMonkey/2.0.8',
            Version('2.0.8', '2', '0'))
        self.versionTest(
            'Mozilla/5.0 (SymbianOS/9.2; U; Series60/3.1 NokiaE90-1/07.24.0.3; Profile/MIDP-2.0 '
            'Configuration/CLDC-1.1 ) AppleWebKit/413 (KHTML, like Gecko) Safari/413 UP.Link/6.2.3.18.0',
            None)
        self.versionTest('Mozilla/5.0 (compatible; Googlebot/2.1; http:#www.google.com/bot.html)',
                         None)  # no version information for some browsers
        self.versionTest(
            'Mozilla/5.0 (Linux; U; Android-4.0.3; en-us; Xoom Build/IML77) AppleWebKit/535.7 (KHTML, like Gecko) '
            'CrMo/16.0.912.75 Safari/535.7',
            Version('16.0.912.75', '16', '0'))
        self.versionTest(
            'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_3; en-us; Silk/1.1.0-80) AppleWebKit/533.16 (KHTML, '
            'like Gecko) Version/5.0 Safari/533.16 Silk-Accelerated=true',
            Version('1.1.0-80', '1', '1'))
